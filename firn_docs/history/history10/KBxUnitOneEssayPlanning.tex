...
\label{sec:orgbf0470d}
\subsection{Prompt}
\label{sec:orga6e770b}
\begin{verbatim}
...
\label{sec:orgd6e8b7f}
\subsubsection{Evidence bin}
\label{sec:orge60b3ba}
\begin{itemize}
\item Plague
...
\label{sec:orgd8766c6}
\begin{enumerate}
\item Thesis: Bellicist theory
\label{sec:orge1f45fb}
\begin{itemize}
\item Intro
