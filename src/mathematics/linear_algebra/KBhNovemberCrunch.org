...
A vector space is "finite-dimensional" if some list of vector in it could span the space. i.e. there exists a list of vectors that span the space. Otherwise, it is called "infinite dimensional".
