...
Per the torque (prime frame) theorem, we can define an origin at the "horizontal" center of mass position of the flywheel. The $CoM$ begins with of course no sag, but Should the flywheel ssa
