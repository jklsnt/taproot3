...
The direction of presession, as we have established before, is consistent with the direction of the angular momentum change resulting from the added torque. By the right hand rule, we can figure that the direction of procession should be 
