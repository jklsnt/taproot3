...
At the final end state, there is $15 \choose 2$ out of order pairs (choose any of the tiles, choose any other one, swapping the order would be the same choice.)
