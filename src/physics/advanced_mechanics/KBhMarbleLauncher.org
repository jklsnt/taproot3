...
\Rightarrow & - {\frac{1}{4(H-h_0)} x_f}^2 (2cos^{-3}(\theta_0) sin(\theta_0)) - sec(2\theta_0) x_f = \\& \frac{1}{4(H-h_0)} (2{x_f} \frac{dx_f}{d\theta_0}) cos^{-2}(\theta_0) +  (\frac{dx_f}{d\theta_0} tan(\theta_0) + sec(2\theta_0) x_f)\\
\Rightarrow & - {\frac{1}{4(H-h_0)} x_f}^2 (2cos^{-3}(\theta_0) sin(\theta_0)) =  \frac{dx_f}{d\theta_0} \frac{1}{4(H-h_0)} (2{x_f} ) cos^{-2}(\theta_0) +  (tan(\theta_0) + sec(2\theta_0) x_f)\\
\end{align}
