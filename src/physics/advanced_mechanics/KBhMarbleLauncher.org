...
\Rightarrow \frac{d}{d\theta_0} 0 =& \frac{-1}{4} \frac{-1}{(H-h_0)} (\frac{d}{d\theta_0} {x_f}^2 cos^{-2}(\theta_0) + \frac{d}{d\theta_0} {x_f}^2 cos^{-2}(\theta_0)) + \frac{d}{d\theta_0} x_f tan(\theta_0) + 0 \\
\end{align}
