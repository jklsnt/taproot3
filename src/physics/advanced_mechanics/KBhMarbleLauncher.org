...
\Rightarrow \frac{-2(H-h_0)}{x_f} =& \frac{sin(\theta_0)cos^2(\theta_0)-sin^3(\theta_0)}{cos^3(\theta_0)} \\
\Rightarrow \frac{-2(H-h_0)}{x_f} =& \frac{sin(\theta_0)cos^2(\theta_0)}{cos^3(\theta_0)}-tan^3(\theta_0) \\
\Rightarrow \frac{-2(H-h_0)}{x_f} =& \frac{sin(\theta_0)}{cos(\theta_0)}-tan^3(\theta_0) \\
\Rightarrow \frac{-2(H-h_0)}{x_f} =& tan(\theta_0)-tan^3(\theta_0) \\
=& -tan^3(\theta_0)+tan(\theta_0)+\frac{2(H-h_0)}{x_f} \\
=& tan^3(\theta_0)-tan(\theta_0)+\frac{2(h_0-H)}{x_f} \\
\end{align}
