...
\Rightarrow 0 =& \frac{-1}{4} \frac{-1}{(H-h_0)} ((2{x_f} \frac{dx_f}{d\theta_0}) cos^{-2}(\theta_0) + {x_f}^2 (-2cos^{-3}(\theta_0))) + \\& ((\frac{d}{d\theta_0} x_f) tan(\theta_0) + \\&  (\frac{d}{d\theta_0} tan(\theta_0)) x_f) + 0 \\
\end{align}
