...
Given that we know that time is positive in the setup, and subtracting a term will make it even more negative
...
\begin{align}
    ...
    =&  \frac{\frac{-1}{2} \vec{v_0}^2 sin(2\theta_0) \pm \vec{v_0}cos(\theta_0)\sqrt{(\vec{v_0}sin(\theta_0))^2 + 2gh_0}}{g}\\
    =&  \frac{-\vec{v_0}^2 sin(2\theta_0)}{2g} \pm  \frac{\vec{v_0}cos(\theta_0)\sqrt{\vec{v_0}^2sin^2(\theta_0) + 2gh_0}}{g}\\
\end{align}
