...
\Rightarrow \frac{-2(H-h_0)}{x_f} =& \frac{sin(\theta_0)(1-2sin^2\theta)}{cos^3(\theta_0)} \\
\Rightarrow \frac{-2(H-h_0)}{x_f} =& \frac{sin(\theta_0)-2sin^3(\theta)}{cos^3(\theta_0)} 
\Rightarrow \frac{-2(H-h_0)}{x_f} =& tan(\theta_0) \frac{1}{cos(\theta_0)}-2sin^3(\theta)}{cos^3(\theta_0)} 
\end{align}
