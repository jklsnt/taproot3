...
Performing the actual solution, 
# 
...
expand(solve([m1*v0 == m1*vf+m2*vcm, m1*v0^2==m1*vf^2+m2*vcm^2+I*w^2, vf==w*r], vf, vcm, w, to_poly_solve=True))
#+end_src

#+RESULTS:
: (I, m1, v0, m2, r)
: (vf, vcm, w)
: [[vf == (m1^2*r^2*v0 + sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*r*v0)/((m1^2 + m1*m2)*r^2 + I*m2), vcm == -(sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*m1*r*v0 - (m1^2*m2*r^2 + I*m1*m2)*v0)/(I*m2^2 + (m1^2*m2 + m1*m2^2)*r^2), w == (m1^2*r*v0 + sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*v0)/((m1^2 + m1*m2)*r^2 + I*m2)], [vf == (m1^2*r^2*v0 - sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*r*v0)/((m1^2 + m1*m2)*r^2 + I*m2), vcm == (sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*m1*r*v0 + (m1^2*m2*r^2 + I*m1*m2)*v0)/(I*m2^2 + (m1^2*m2 + m1*m2^2)*r^2), w == (m1^2*r*v0 - sqrt(m1^2*m2^2*r^2 - I*m1^2*m2 + I*m1*m2^2)*v0)/((m1^2 + m1*m2)*r^2 + I*m2)]]
