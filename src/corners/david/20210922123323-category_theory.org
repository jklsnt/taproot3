...
** Origins
- At some point Feynman realized that it's useful to draw linear operators as [[file:20210922132026-feynman_diagrams.org][diagrams]] in a systematic manner.
...
- Curry-Howard correspondence
  - Person that [[file:20210922132544-haskell.org][Haskell]] is named after
...
Idea of turning an operation into an object? Connection to [[file:20210922143034-currying.org][currying]].
