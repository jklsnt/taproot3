...
- No [[file:20200909105807-current.org][current]] flows across a capacitor as there is a gap of air/plastic (insulator called dieletric) between them. 
...
$\epsilon_0$ shows up in [[file:phys250-electricalforce.org][Coloumb's Law]] as well.
