:PROPERTIES:
:ID:       3CDB43DD-F180-4284-B572-085131AB73E6
:END:
...
* Basic Concepts
** Limit Definition
[[id:CCC6F45E-AD12-450A-8786-31058026AF78][Limits]] have not been rigorously defined in this class so the explanation that $\lim\limits_{x\rightarrow y}$ is the value of $f(x)$ when $x$ "tends toward" or gets infinitely close to $y$.
** Two-sided Limits
...
** Discontinuity
Several types of dis[[id:317D5898-0F2A-40DC-A1E4-A8A98F60B5BD][continuity]] exist:
...
** Squeeze Theorem
See [[id:630EE901-EFBD-41DC-9753-1401B60A8F20][Squeeze Theorem]] definition
* Calculating Limits
** Graphically
