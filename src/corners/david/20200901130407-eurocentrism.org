...
Max Weber (see [[file:hist-states.org][States]]) claims that it is because of sociological reasons and that Calvinism (branch of Protestantism) encouraged Europeans to be concerned with material gain and had "proto-capitalist ideals". This (according to Weber) was not the case in other states.
