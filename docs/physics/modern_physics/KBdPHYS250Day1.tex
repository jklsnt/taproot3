...
\section{Homework}
\label{sec:orgf3e453b}
\subsection{Lecture Notes}
\label{sec:orgfb96574}
Might not be complete.

\subsubsection{Electrostatics Basics}
\label{sec:orgeaaa084}
\begin{itemize}
