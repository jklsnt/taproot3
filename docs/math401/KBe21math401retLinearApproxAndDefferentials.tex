...
\label{sec:org77d0440}

\subsection{cube root}
\label{sec:orgf907229}

\subsubsection{approximation}
\label{sec:org38c8c82}
...
\subsection{sin(x)}
\label{sec:org1a42c11}

\subsubsection{approximation}
\label{sec:org17c6ad2}
\[ y \approx \frac{d}{dx} \sin x \Bigr|_0 (x-0) + \sin 0 = x \]

\subsubsection{estimates}
\label{sec:org7672119}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
...
\label{sec:org89e54fd}

\subsubsection{approximation}
\label{sec:orgba2cb44}
\[ y \approx \frac{d}{dx} f(x) \Bigr|_c (x-c) + f(c) \]
plugging in \(c = 1\),
\[ y \approx 5(x-1)-4 \]

\subsubsection{estimations}
\label{sec:orgae063a7}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
