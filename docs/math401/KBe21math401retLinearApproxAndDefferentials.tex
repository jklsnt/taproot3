...
\label{sec:org3bcf7c7}

\subsection{cube root}
\label{sec:org82ca79a}

\subsubsection{approximation}
\label{sec:org7458fde}
...
\subsection{sin(x)}
\label{sec:org0895a45}

\subsubsection{approximation}
\label{sec:orgc421ec4}
\[ y \approx \frac{d}{dx} \sin x \Bigr|_0 (x-0) + \sin 0 = x \]

\subsubsection{estimates}
\label{sec:org04cf839}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
...
\label{sec:orga0672cd}

\subsubsection{approximation}
\label{sec:orgab19480}
\[ y \approx \frac{d}{dx} f(x) \Bigr|_c (x-c) + f(c) \]
plugging in \(c = 1\),
\[ y \approx 5(x-1)-4 \]

\subsubsection{estimations}
\label{sec:orgd5c1d05}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
