...
\section{Problems}
\label{sec:org51bddbe}

\subsection{exr1.3}
\label{sec:org41e09a7}
...
\label{sec:org217ee95}
0.21875 using the left estimate

\subsection{exr1.5}
\label{sec:orgfc1c3e2}

\subsubsection{left estimate}
\label{sec:orgc3cbe4d}
...
\subsection{exr1.6}
\label{sec:org2cf4946}

\subsubsection{\(\int_0^1 \sqrt{x^2+1}dx\)}
\label{sec:orgc00546e}
...
\label{sec:orgaa6ed92}
See exr1.3

\subsection{exr1.11}
\label{sec:org1f325ae}
