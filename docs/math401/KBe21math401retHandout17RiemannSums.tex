...
\section{Problems}
\label{sec:org2562d44}

\subsection{exr1.3}
\label{sec:org68ab5be}
...
\label{sec:org5caabfb}
0.21875 using the left estimate

\subsection{exr1.5}
\label{sec:org19562db}

\subsubsection{left estimate}
\label{sec:orgee4682c}
...
\subsection{exr1.6}
\label{sec:org8514136}

\subsubsection{\(\int_0^1 \sqrt{x^2+1}dx\)}
\label{sec:org72b4af6}
...
\label{sec:orgaec3646}
See exr1.3

\subsection{exr1.11}
\label{sec:org18a1632}
