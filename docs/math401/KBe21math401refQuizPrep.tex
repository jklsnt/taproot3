...
\maketitle
\section{Derivatives}
\label{sec:org988a8b9}
\subsection{Common}
\label{sec:org3648224}
\begin{center}
\begin{tabular}{ll}
function & derivative\\
\hline
...
\label{sec:orga0728ab}
\[ \frac{d}{dx} x^n = nx^{n-1} \]

\section{Approximation}
\label{sec:org6cb0c24}
\subsection{Linear Approximation at a Point}
\label{sec:org522bb18}
\[ y = f(a) + f'(a)(x-a) \]
(First order taylor series)
\subsection{Differentials}
\label{sec:org19317a9}
\[ dy = f'(x)dx \]
