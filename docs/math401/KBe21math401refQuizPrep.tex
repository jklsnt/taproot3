...
\maketitle
\section{Derivatives}
\label{sec:orga9263aa}
\subsection{Common}
\label{sec:org58697c3}
\begin{center}
\begin{tabular}{ll}
function & derivative\\
\hline
...
\label{sec:org7248823}
\[ \frac{d}{dx} x^n = nx^{n-1} \]

\section{Approximation}
\label{sec:org0b9703d}
\subsection{Linear Approximation at a Point}
\label{sec:org2fdabf4}
\[ y = f(a) + f'(a)(x-a) \]
(First order taylor series)
\subsection{Differentials}
\label{sec:orgfe270f2}
\[ dy = f'(x)dx \]
