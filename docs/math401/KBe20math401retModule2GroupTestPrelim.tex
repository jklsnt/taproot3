...
\label{sec:org8dab3c9}
\subsection{\([0, 1)\): not a closed interval}
\label{sec:org1c529f6}
\subsection{\((0, 1]\): not a closed interval}
\label{sec:org94832af}
\subsection{\((0, 1]\): not continuous, not a closed interval}
\label{sec:org7963bac}
\subsection{\(f(x) = \frac{1}{x}\): not continuous}
\label{sec:org4abe157}
\section{Epilouge}
\label{sec:orge860b46}
