...
\label{sec:org1dbe02b}
\subsection{complete the table}
\label{sec:orga10b1c4}
\begin{center}
...
\subsection{sketch the function}
\label{sec:org0af2b11}
same as 1b

\section{complete the table}
\label{sec:org6d5b5bc}
\begin{center}
\begin{tabular}{llll}
 & \(F(x)\) & \(G(x)\) & \(H(x)\)\\
maximum & 4n+2 &  & \\
...
\label{sec:orgc786471}

\subsection{\(F(x) = \int_{-1}^{x^2} \sin(t^3-1) dt\)}
\label{sec:org0d15c74}
