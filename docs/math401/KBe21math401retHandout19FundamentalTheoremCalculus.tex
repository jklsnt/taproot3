...
\label{sec:org509456a}
\subsection{complete the table}
\label{sec:orge632893}
\begin{center}
...
\subsection{sketch the function}
\label{sec:orged1fcc3}
same as 1b

\section{complete the table}
\label{sec:org6216941}
\begin{center}
\begin{tabular}{llll}
 & \(F(x)\) & \(G(x)\) & \(H(x)\)\\
maximum & 4n+2 &  & \\
...
\label{sec:org7e3989e}

\subsection{\(F(x) = \int_{-1}^{x^2} \sin(t^3-1) dt\)}
\label{sec:org83203a0}
