...
\maketitle
\section{Definitions}
\label{sec:orga4886b7}
\subsection{Linear Map}
\label{sec:org38a6f15}
...
\label{sec:orgf62bc0a}
\subsection{Contains Zero}
\label{sec:org6f70411}
Let \(v = T0\).
$$
...
\label{sec:orgf1aec54}

\subsection{In the forwards direction}
\label{sec:org2daca09}
