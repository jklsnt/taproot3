...
\label{sec:org68739ca}
\subsection{linear algebra done right (Axler 5.A)}
\label{sec:orgf7ea2a6}
\section{motivation}
\label{sec:org23198d3}
...
\label{sec:org8daf28c}
\end{enumerate}

\section{eigenvector\hfill{}\textsc{def}}
\label{sec:org2de02ea}
\begin{quote}
...
\subsection{results}
\label{sec:org1c48f50}

\subsubsection{equivalent condition}
\label{sec:org1519c82}
\begin{quote}
