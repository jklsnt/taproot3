...
\label{sec:org8106cb4}
\end{enumerate}
\item function problems
\label{sec:org3c15437}
...
\label{sec:org864c888}
\end{enumerate}
\item size of an instance
\label{sec:org4ff3ce1}
...
\label{sec:org733e57e}
\begin{enumerate}
\item Turing machine
\label{sec:org95efdb2}
...
\label{sec:orga72a6bd}
\end{enumerate}
\item best/worst/average case
\label{sec:org62466b4}
...
\label{sec:org4925796}
\begin{enumerate}
\item P vs NP
\label{sec:org80804cf}
