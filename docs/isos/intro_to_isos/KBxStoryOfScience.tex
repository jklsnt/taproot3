...
\section{Lets go.}
\label{sec:orgdfa75a6}
\subsection{Story of Haber | rough notes}
\label{sec:orga45b64f}
\begin{itemize}
...
\label{sec:orgda59cc6}
idea: yin yang, with infographic

\begin{enumerate}
\item yin:
\label{sec:orgf7ba83c}
