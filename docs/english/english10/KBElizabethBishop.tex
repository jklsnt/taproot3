...
\label{sec:orgc75d72d}
\begin{enumerate}
\item \emph{\(Elizabeth\ Bishop\)}
\label{sec:org2764d71}
...
\label{sec:org7e8719f}

\begin{enumerate}
\item Thesis:
\label{sec:org1acdbcb}
\begin{itemize}
\item Context
...
\label{sec:org6165213}
\begin{enumerate}
\item \[:sunglasses:\]
\label{sec:org0a28632}
