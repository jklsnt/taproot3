...
\label{sec:org5c1ac60}
\subsection{\([0, 1)\): not a closed interval}
\label{sec:orgb7441f5}
\subsection{\((0, 1]\): not a closed interval}
\label{sec:orge48ae65}
\subsection{\((0, 1]\): not continuous, not a closed interval}
\label{sec:orgd75e00f}
\subsection{\(f(x) = \frac{1}{x}\): not continuous}
\label{sec:orgfb644a6}
\section{Epilouge}
\label{sec:org123fc26}
