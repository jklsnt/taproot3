...
\label{sec:org261dd39}
\subsection{\([0, 1)\): not a closed interval}
\label{sec:org2a281fa}
\subsection{\((0, 1]\): not a closed interval}
\label{sec:orgde9cefc}
\subsection{\((0, 1]\): not continuous, not a closed interval}
\label{sec:org42c3220}
\subsection{\(f(x) = \frac{1}{x}\): not continuous}
\label{sec:org2dbae63}
\section{Epilouge}
\label{sec:org1abc498}
