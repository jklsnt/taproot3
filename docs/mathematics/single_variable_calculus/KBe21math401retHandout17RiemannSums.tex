...
\section{Problems}
\label{sec:org6b4ff6c}

\subsection{exr1.3}
\label{sec:org1fa8403}
...
\label{sec:org06450e7}
0.21875 using the left estimate

\subsection{exr1.5}
\label{sec:orgc23865c}

\subsubsection{left estimate}
\label{sec:orgb7564cc}
...
\subsection{exr1.6}
\label{sec:org5df7af3}

\subsubsection{\(\int_0^1 \sqrt{x^2+1}dx\)}
\label{sec:org20c019f}
...
\label{sec:orgc764d92}
See exr1.3

\subsection{exr1.11}
\label{sec:orgb0ef6ba}
