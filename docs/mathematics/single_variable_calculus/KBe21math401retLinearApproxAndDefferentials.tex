...
\label{sec:orgd5dfcd6}

\subsection{cube root}
\label{sec:org0cc30f9}

\subsubsection{approximation}
\label{sec:orgd9e2aff}
...
\subsection{sin(x)}
\label{sec:org75965be}

\subsubsection{approximation}
\label{sec:org3668214}
\[ y \approx \frac{d}{dx} \sin x \Bigr|_0 (x-0) + \sin 0 = x \]

\subsubsection{estimates}
\label{sec:org4c415a2}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
...
\label{sec:org4e4e22a}

\subsubsection{approximation}
\label{sec:org7a3d925}
\[ y \approx \frac{d}{dx} f(x) \Bigr|_c (x-c) + f(c) \]
plugging in \(c = 1\),
\[ y \approx 5(x-1)-4 \]

\subsubsection{estimations}
\label{sec:org8dcc48c}
\begin{center}
\begin{tabular}{rr}
value & estimate\\
\hline
