...
\subsection{c}
\label{sec:orgb1e80f0}
$$
   \boxed{x = 0.8655 \pm 0.005}
   $$
\section{164}
\label{sec:org2dac967}
$$\boxed{\text{It's true.}}$$
\end{document}
