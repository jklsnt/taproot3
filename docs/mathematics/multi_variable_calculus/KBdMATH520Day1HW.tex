...
\section{Problem 1}
\label{sec:orgb6bbef6}
Differentiate (with respect to x)

\subsection{\((a)\)}
\label{sec:org135c314}
$\backslash$[
\begin{aligned}
...
\section{Problem 5}
\label{sec:orgbe64521}
Find antiderivatives

\section{\((a)\)}
\label{sec:org3a6e3b9}
$\backslash$[
\begin{aligned}
...
\section{Problem 6}
\label{sec:org44e5ff9}
\(f(x) = 2x^5 - 10x^4 - 70x^3\)

\subsection{\((a)\)}
\label{sec:org7c5df5d}
