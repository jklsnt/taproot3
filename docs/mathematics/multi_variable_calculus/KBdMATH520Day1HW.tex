...
\section{Problem 1}
\label{sec:org14c22b4}
Differentiate (with respect to x)

\subsection{\((a)\)}
\label{sec:org947723b}
$\backslash$[
\begin{aligned}
...
\section{Problem 5}
\label{sec:orge803eb6}
Find antiderivatives

\section{\((a)\)}
\label{sec:org43e32c5}
$\backslash$[
\begin{aligned}
...
\section{Problem 6}
\label{sec:org7a5fb36}
\(f(x) = 2x^5 - 10x^4 - 70x^3\)

\subsection{\((a)\)}
\label{sec:org67b8629}
