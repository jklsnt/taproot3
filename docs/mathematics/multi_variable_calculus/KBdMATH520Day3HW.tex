...
\label{sec:org913ca97}
\subsection{Problem 1}
\label{sec:org75a9189}
\subsubsection{\((e)\)}
\label{sec:org3b38e7a}
$\backslash$[
\begin{aligned}
...
\label{sec:org0d42866}
\subsubsection{\((a)\)}
\label{sec:orgdfb3bc5}
$\backslash$[
\begin{aligned}
V &= 24.0Lmol^{-1} \\
V(t) &= 24t \\
...
\label{sec:org00cbd1b}
\subsubsection{\((e)\)}
\label{sec:org2ec5fd2}
$\backslash$[
\begin{aligned}
...
\section{Arc Length}
\label{sec:org309a8b6}
\subsection{Problem 2}
\label{sec:orgd7804c9}
$\backslash$[
\begin{aligned}
f(x) &= \frac{x^2}{8} - \ln{x} \\
