...
\label{sec:org39635d7}
\subsection{Problem 1}
\label{sec:org83d66bb}
\subsubsection{\((e)\)}
\label{sec:org50f1f1d}
$\backslash$[
\begin{aligned}
...
\label{sec:org44b050d}
\subsubsection{\((a)\)}
\label{sec:orgb9b89f1}
$\backslash$[
\begin{aligned}
V &= 24.0Lmol^{-1} \\
V(t) &= 24t \\
...
\label{sec:orge49ec08}
\subsubsection{\((e)\)}
\label{sec:orgb549472}
$\backslash$[
\begin{aligned}
...
\section{Arc Length}
\label{sec:org7769e4b}
\subsection{Problem 2}
\label{sec:org7793d64}
$\backslash$[
\begin{aligned}
f(x) &= \frac{x^2}{8} - \ln{x} \\
