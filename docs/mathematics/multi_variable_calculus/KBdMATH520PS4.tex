...
\label{sec:org7c23cc6}
\subsection{\((1)\) and \((2)\)}
\label{sec:org3c409ee}
...
\section{Vectors}
\label{sec:org3eb3438}
\subsection{\((2)\)}
\label{sec:orgc643f7d}
Magnitude: \(\sqrt{10}\)

Direction: \(<\frac{3}{\sqrt{10}}, -\frac{1}{\sqrt{10}}>\)

\subsection{\((5)\)}
\label{sec:org193a263}
Magnitude: \(\sqrt{21}\)
