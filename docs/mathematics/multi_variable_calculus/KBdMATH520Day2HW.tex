...
\label{sec:orgdec875c}
\subsection{Problem 1}
\label{sec:orge175f13}
\subsubsection{\((b)\)}
\label{sec:orgd435333}
$\backslash$[
\begin{aligned}
...
\label{sec:orgecfb167}
\subsubsection{\((b)\)}
\label{sec:orge340abd}
$\backslash$[
\begin{aligned}
...
\label{sec:org5fa1808}
\subsubsection{\((b)\)}
\label{sec:org675a448}
$\backslash$[
\begin{aligned}
A &= \int_{-1}^{-2} f(x) \,dx \\
