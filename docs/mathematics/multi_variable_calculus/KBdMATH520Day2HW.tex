...
\label{sec:orgfe07284}
\subsection{Problem 1}
\label{sec:orgef6a1f9}
\subsubsection{\((b)\)}
\label{sec:orgf971ab1}
$\backslash$[
\begin{aligned}
...
\label{sec:org81f256d}
\subsubsection{\((b)\)}
\label{sec:orgdbd954b}
$\backslash$[
\begin{aligned}
...
\label{sec:org553fd78}
\subsubsection{\((b)\)}
\label{sec:org6598ffb}
$\backslash$[
\begin{aligned}
A &= \int_{-1}^{-2} f(x) \,dx \\
