...
\maketitle
\section{Definitions}
\label{sec:orgabd9309}
\subsection{Linear Map}
\label{sec:orgb5a2dfc}
...
\label{sec:org1ed5990}
\subsection{Contains Zero}
\label{sec:org7dcee8c}
Let \(v = T0\).
$$
...
\label{sec:orga4357e2}

\subsection{In the forwards direction}
\label{sec:org9f1334a}
