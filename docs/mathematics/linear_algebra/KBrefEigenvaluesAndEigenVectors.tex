...
\label{sec:org0ebbd85}
\subsection{linear algebra done right (Axler 5.A)}
\label{sec:org5ac1cf5}
\section{motivation}
\label{sec:org3e1de57}
...
\label{sec:org560660f}
\end{enumerate}

\section{eigenvector\hfill{}\textsc{def}}
\label{sec:org58ad264}
\begin{quote}
...
\subsection{results}
\label{sec:org784a110}

\subsubsection{equivalent condition}
\label{sec:org7beac15}
\begin{quote}
