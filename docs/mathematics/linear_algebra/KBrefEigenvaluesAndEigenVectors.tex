...
\label{sec:org0c47357}
\subsection{linear algebra done right (Axler 5.A)}
\label{sec:org1ea2d36}
\section{motivation}
\label{sec:org4525588}
...
\label{sec:orgfc48ca3}
\end{enumerate}

\section{eigenvector\hfill{}\textsc{def}}
\label{sec:org4566e0f}
\begin{quote}
...
\subsection{results}
\label{sec:org7d91d31}

\subsubsection{equivalent condition}
\label{sec:orgcc13a87}
\begin{quote}
