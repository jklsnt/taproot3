...
\label{sec:org943ba8d}
\ldots{}that Wes did.

\subsubsection{What are we protecting?}
\label{sec:org0c33dfd}
...
\label{sec:orgae58bf9}

\begin{enumerate}
\item Protecting From\ldots{}
\label{sec:org9d0857d}
\begin{itemize}
