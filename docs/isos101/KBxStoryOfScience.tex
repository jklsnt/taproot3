...
\section{Lets go.}
\label{sec:org5d9a5d9}
\subsection{Story of Haber | rough notes}
\label{sec:orge57f569}
\begin{itemize}
...
\label{sec:org9aa3730}
idea: yin yang, with infographic

\begin{enumerate}
\item yin:
\label{sec:orgcc4cdad}
