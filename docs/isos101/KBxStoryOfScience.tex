...
\section{Lets go.}
\label{sec:org9d2165c}
\subsection{Story of Haber | rough notes}
\label{sec:org7cd11b9}
\begin{itemize}
...
\label{sec:org97b6bf4}
idea: yin yang, with infographic

\begin{enumerate}
\item yin:
\label{sec:org52db79c}
