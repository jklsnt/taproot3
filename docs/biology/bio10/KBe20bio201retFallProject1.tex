...
\begin{enumerate}
\item optimizations
\label{sec:orgde09a95}

\begin{enumerate}
\item conformational sampling?
\label{sec:orgc99a69a}
\begin{itemize}
...
\label{sec:org5121275}
\end{enumerate}
\item membrane potential
\label{sec:orge92f333}
...
\label{sec:org6d33610}
\end{enumerate}
\item Impulse speed
\label{sec:org05c32a7}
\begin{enumerate}
\item larger diameter axon
\label{sec:org2d6262d}
...
\label{sec:orge5a010c}
\end{enumerate}
\end{enumerate}
\item Salt bridge
\label{sec:org18c2442}
...
\section{Meetings}
\label{sec:orgbec9bf1}

\subsection{12 oct 2020}
\label{sec:org32609a5}
\begin{itemize}
...
\label{sec:org3f2dc5d}

\subsubsection{Nav}
\label{sec:org46332a7}

\begin{enumerate}
\item side view, all alpha domains
\label{sec:orgc53c2bc}

\item top view, all alpha domains
\label{sec:org1e3bd2e}

\begin{enumerate}
\item open/close?
\label{sec:org34965b2}
\end{enumerate}
\end{enumerate}
\end{document}
