...
\label{sec:org9f62e5d}
\subsection{Problem 1}
\label{sec:orge933255}
\subsubsection{\((b)\)}
\label{sec:orgacf1439}
$\backslash$[
\begin{aligned}
...
\label{sec:orgaf1aee8}
\subsubsection{\((b)\)}
\label{sec:org15c10fe}
$\backslash$[
\begin{aligned}
...
\label{sec:org6de89e7}
\subsubsection{\((b)\)}
\label{sec:org2cd1775}
$\backslash$[
\begin{aligned}
A &= \int_{-1}^{-2} f(x) \,dx \\
