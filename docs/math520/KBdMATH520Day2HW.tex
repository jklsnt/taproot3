...
\label{sec:org055b2e5}
\subsection{Problem 1}
\label{sec:orga017b96}
\subsubsection{\((b)\)}
\label{sec:org9b747f1}
$\backslash$[
\begin{aligned}
...
\label{sec:org58795ee}
\subsubsection{\((b)\)}
\label{sec:org66d8c4a}
$\backslash$[
\begin{aligned}
...
\label{sec:orgc9334b4}
\subsubsection{\((b)\)}
\label{sec:org1c6ba67}
$\backslash$[
\begin{aligned}
A &= \int_{-1}^{-2} f(x) \,dx \\
