...
\label{sec:orgd0afff6}
\subsection{\((1)\) and \((2)\)}
\label{sec:org6127720}
...
\section{Vectors}
\label{sec:org491cee5}
\subsection{\((2)\)}
\label{sec:orge1e8a32}
Magnitude: \(\sqrt{10}\)

Direction: \(<\frac{3}{\sqrt{10}}, -\frac{1}{\sqrt{10}}>\)

\subsection{\((5)\)}
\label{sec:org4c7d637}
Magnitude: \(\sqrt{21}\)
