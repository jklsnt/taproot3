...
\section{Problem 1}
\label{sec:org109c7a9}
Differentiate (with respect to x)

\subsection{\((a)\)}
\label{sec:orgbdb0a48}
$\backslash$[
\begin{aligned}
...
\section{Problem 5}
\label{sec:org14af341}
Find antiderivatives

\section{\((a)\)}
\label{sec:org1a40c19}
$\backslash$[
\begin{aligned}
...
\section{Problem 6}
\label{sec:orgc467140}
\(f(x) = 2x^5 - 10x^4 - 70x^3\)

\subsection{\((a)\)}
\label{sec:org285895c}
