...
\label{sec:orgf614bf8}
\subsection{Problem 1}
\label{sec:orgce8d90f}
\subsubsection{\((e)\)}
\label{sec:orgfbb6054}
$\backslash$[
\begin{aligned}
...
\label{sec:orgac5602b}
\subsubsection{\((a)\)}
\label{sec:org3a46f0d}
$\backslash$[
\begin{aligned}
V &= 24.0Lmol^{-1} \\
V(t) &= 24t \\
...
\label{sec:org8edb453}
\subsubsection{\((e)\)}
\label{sec:orge28c2e8}
$\backslash$[
\begin{aligned}
...
\section{Arc Length}
\label{sec:org2637660}
\subsection{Problem 2}
\label{sec:org4816540}
$\backslash$[
\begin{aligned}
f(x) &= \frac{x^2}{8} - \ln{x} \\
