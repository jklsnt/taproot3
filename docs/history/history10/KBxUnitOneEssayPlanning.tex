...
\label{sec:org2372df4}
\subsection{Prompt}
\label{sec:org7771856}
\begin{verbatim}
...
\label{sec:org404b2ac}
\subsubsection{Evidence bin}
\label{sec:org9fde770}
\begin{itemize}
\item Plague
...
\label{sec:org3cb471c}
\begin{enumerate}
\item Thesis: Bellicist theory
\label{sec:org7b16223}
\begin{itemize}
\item Intro
