...
\label{sec:org5ca2963}
\subsection{Prompt}
\label{sec:org78c5b7b}
\begin{verbatim}
...
\label{sec:orgea23b1b}
\subsubsection{Evidence bin}
\label{sec:org9241c30}
\begin{itemize}
\item Plague
...
\label{sec:orge305f4b}
\begin{enumerate}
\item Thesis: Bellicist theory
\label{sec:org7069f82}
\begin{itemize}
\item Intro
