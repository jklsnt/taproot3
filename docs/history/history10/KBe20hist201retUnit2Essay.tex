...
\end{quote}
\section{Outline}
\label{sec:orgf57a960}
\subsection{Intro}
\label{sec:org204f4b4}
\subsubsection{Background Info}
\label{sec:orgd47a3b0}
\begin{enumerate}
\item Raison d'etat
\label{sec:org5a1670a}
...
\label{sec:org648fbed}

\subsection{Caribbean}
\label{sec:org3571f27}
...
\label{sec:org3342be0}

\subsection{Conclusion}
\label{sec:orgcdff9d8}

\subsubsection{Summarize}
\label{sec:orgc1767a8}
