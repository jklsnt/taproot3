...
\end{quote}
\section{Outline}
\label{sec:org37078c9}
\subsection{Intro}
\label{sec:org8612e34}
\subsubsection{Background Info}
\label{sec:orgb80e6ac}
\begin{enumerate}
\item Raison d'etat
\label{sec:org6cfdcfa}
...
\label{sec:org10bb5ce}

\subsection{Caribbean}
\label{sec:org91fe26c}
...
\label{sec:org338ff58}

\subsection{Conclusion}
\label{sec:org47857a0}

\subsubsection{Summarize}
\label{sec:org01afd5f}
