...
\section{Prompt}
\label{sec:org361335c}
\section{Planning}
\label{sec:org2ed900b}
\begin{itemize}
...
\subsection{Ming}
\label{sec:org3386455}
\subsubsection{Smuggled Silver}
\label{sec:org8c0698a}
...
\label{sec:orga176303}
\subsubsection{Ming}
\label{sec:org86373b6}
\begin{itemize}
...
\section{Outlining}
\label{sec:org3b74d3a}
\subsection{Thesis Ideas}
\label{sec:orgb51f575}
...
\label{sec:orgde579e3}
\subsubsection{Topic}
\label{sec:org5dc35eb}
Both the Ming and Ottoman empires suffered from economies weakened by
instability and revolt caused by inflation.

\subsubsection{Evidence}
\label{sec:org17b18df}
\begin{itemize}
\item ”
\end{itemize}

\subsection{Body 2}
\label{sec:orgc1ba8f5}
\subsubsection{Topic}
\label{sec:orga5e7ac3}
\subsubsection{Evidence}
\label{sec:orgca1121f}
\subsection{Body 3}
\label{sec:org8fc4a36}
\subsubsection{Topic}
\label{sec:org1bef461}
\subsubsection{Evidence}
\label{sec:orgc99c78e}
\section{Sources}
\label{sec:org06527d9}
\begin{itemize}
