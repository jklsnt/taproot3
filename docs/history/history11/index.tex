...
\label{sec:org7b7ca48}
\begin{itemize}
\item \href{KBdHIST301FrenchIndianWar.org}{KBdHIST301FrenchIndianWar}
\item \href{KBhFrenchIndianWar.org}{KBhFrenchIndianWar}
\end{itemize}
\end{document}
