...
We are given that \(v(0)=v_0\). \(v(0) = C = v_0\), hence, \(C=v_0\). Therefore,
...
Again, substituting \(C = y_0\), we derive the result for the position equation.
