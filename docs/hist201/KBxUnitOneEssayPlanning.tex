...
\label{sec:org89162c9}
\subsection{Prompt}
\label{sec:org5da1b57}
\begin{verbatim}
...
\label{sec:orga12c7e5}
\subsubsection{Evidence bin}
\label{sec:org3abe611}
\begin{itemize}
\item Plague
...
\label{sec:orgd42c7d2}
\begin{enumerate}
\item Thesis: Bellicist theory
\label{sec:org0839b2b}
\begin{itemize}
\item Intro
