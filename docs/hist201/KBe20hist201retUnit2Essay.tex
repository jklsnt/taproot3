...
\end{quote}
\section{Outline}
\label{sec:orge7128a9}
\subsection{Intro}
\label{sec:org66f856d}
\subsubsection{Background Info}
\label{sec:orgf33ba3c}
\begin{enumerate}
\item Raison d'etat
\label{sec:orgdf7b2dd}
...
\label{sec:orgbd1509e}

\subsection{Caribbean}
\label{sec:org5edae97}
...
\label{sec:org27cfeca}

\subsection{Conclusion}
\label{sec:org28a625d}

\subsubsection{Summarize}
\label{sec:orgeee6062}
