...
\end{quote}
\section{Outline}
\label{sec:orga9d881c}
\subsection{Intro}
\label{sec:orgc294d1f}
\subsubsection{Background Info}
\label{sec:org5e97edb}
\begin{enumerate}
\item Raison d'etat
\label{sec:orge44bdf3}
...
\label{sec:org1e755ec}

\subsection{Caribbean}
\label{sec:org0501287}
...
\label{sec:org98bb676}

\subsection{Conclusion}
\label{sec:orgd37f78d}

\subsubsection{Summarize}
\label{sec:orgbc5cf45}
