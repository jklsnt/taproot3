...
\section{Prompt}
\label{sec:org83dcf0d}
\section{Planning}
\label{sec:org13155e1}
\begin{itemize}
...
\subsection{Ming}
\label{sec:org9159276}
\subsubsection{Smuggled Silver}
\label{sec:org05eadec}
...
\label{sec:orgebe05e3}
\subsubsection{Ming}
\label{sec:org3e2e8cb}
\begin{itemize}
...
\section{Outlining}
\label{sec:org1573d8f}
\subsection{Thesis Ideas}
\label{sec:orgbf60c5a}
...
\label{sec:org008d4a4}
\subsubsection{Topic}
\label{sec:orgc4cb86a}
Both the Ming and Ottoman empires suffered from economies weakened by
instability and revolt caused by inflation.

\subsubsection{Evidence}
\label{sec:orgc158d3a}
\begin{itemize}
\item ”
\end{itemize}

\subsection{Body 2}
\label{sec:org0ec9b35}
\subsubsection{Topic}
\label{sec:org58ab744}
\subsubsection{Evidence}
\label{sec:org1d7af9c}
\subsection{Body 3}
\label{sec:orgecb68c5}
\subsubsection{Topic}
\label{sec:orgef8abbf}
\subsubsection{Evidence}
\label{sec:orgf4f805a}
\section{Sources}
\label{sec:org56caeda}
\begin{itemize}
