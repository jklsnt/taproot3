...
\label{sec:org4dc8d20}
\item many (6?) ethnic groups
\label{sec:org1b0bfd1}
\end{enumerate}
\end{enumerate}
\subsubsection{quotes}
\label{sec:org5a7597f}
\begin{enumerate}
...
\label{sec:org597304e}
\item lenin
\label{sec:org63c41be}
\begin{enumerate}
...
\label{sec:orgcb0db14}
\end{enumerate}
\item aristotle
\label{sec:org3910534}
\begin{enumerate}
...
\label{sec:org641e8bf}
\end{enumerate}
\end{enumerate}
\section{outline}
\label{sec:orgd1f590a}
