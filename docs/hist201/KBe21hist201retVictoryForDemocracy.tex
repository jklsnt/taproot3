...
\label{sec:org892e66d}
\item many (6?) ethnic groups
\label{sec:org4127054}
\end{enumerate}
\end{enumerate}
\subsubsection{quotes}
\label{sec:org90ec3e7}
\begin{enumerate}
...
\label{sec:orgda9d63c}
\item lenin
\label{sec:orgd65f7f1}
\begin{enumerate}
...
\label{sec:org64aed84}
\end{enumerate}
\item aristotle
\label{sec:orgcef82e1}
\begin{enumerate}
...
\label{sec:orge2d4675}
\end{enumerate}
\end{enumerate}
\section{outline}
\label{sec:org2b02cab}
