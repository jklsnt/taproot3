...
\label{sec:org2e88d30}
\subsection{General Information}
\label{sec:org349a1e8}
\begin{center}
\begin{tabular}{lll}
...
\label{sec:orga3bd1b0}
\subsubsection{The Claim}
\label{sec:orgfe7ba8f}
\begin{enumerate}
\item Scholarly View
\label{sec:org2e4e41d}
\begin{itemize}
