...
\label{sec:org84d37cf}
\begin{enumerate}
\item \emph{\(Elizabeth\ Bishop\)}
\label{sec:org996af1c}
...
\label{sec:org66453c0}

\begin{enumerate}
\item Thesis:
\label{sec:orge1e7479}
\begin{itemize}
\item Context
...
\label{sec:orga468f2e}
\begin{enumerate}
\item \[:sunglasses:\]
\label{sec:orgaa003bb}
